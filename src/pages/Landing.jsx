    ...
    <div className="min-h-screen bg-[#0A090C] text-[#F8FFE5] font-sans selection:bg-[#D16014] selection:text-white">
      ...
      <section id="nosotros" className="py-24 px-6 bg-[#001812] border-y border-[#659B5E]/30 relative overflow-hidden scroll-mt-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex items-center justify-center p-6 sm:p-10 bg-[#0A090C] border-2 border-[#D16014] rounded-3xl shadow-[0_0_60px_rgba(209,96,20,0.4)] overflow-hidden group"><div className="absolute inset-0 bg-gradient-to-tr from-[#D16014]/20 via-[#659B5E]/10 to-transparent" /><div className="relative z-10 text-center space-y-6 w-full flex flex-col items-center"><div className="w-64 h-64 sm:w-80 sm:h-80 rounded-3xl bg-[#001812] border-2 border-[#D16014] p-8 flex items-center justify-center shadow-[0_0_40px_rgba(209,96,20,0.6)] group-hover:scale-105 transition-transform duration-500"><img src={logoBlanco} alt="Logo El Cacique" className="w-full h-full object-contain filter brightness-200 contrast-150 drop-shadow-[0_0_25px_rgba(255,255,255,0.9)]" /></div><div><h3 className="text-3xl sm:text-4xl font-black text-white tracking-wider">EL CACIQUE</h3><p className="text-xs font-mono text-[#D16014] uppercase tracking-widest mt-1 font-bold">Chicharronera Gourmet</p><p className="text-[11px] text-gray-400 mt-2">Propiedad Intelectual &amp; Solución Empresarial © 2026 BVA</p></div></div></div>
        </div>
      </section>
